export default {
  ...
  dashboard: {
    ...
    signOutNav: 'Sign out',
    accountOpenPanel: 'Open account panel',
    accountUserName: 'Username',
    accountUserNamePlaceholder: 'Enter your username',
    accountSaveName: 'Save',
    accountChangePassword: 'Change password',
    accountNewPassword: 'New password (at least 6 chars)',
    accountConfirmPassword: 'Confirm password',
    accountUpdatePassword: 'Update password',
    accountNameRequired: 'Username cannot be empty.',
    accountNameSaved: 'Username updated.',
    ...
    accountActionFailed: 'Action failed. Please try again.',
    ...
    accountDeleteConfirmBtn: 'Confirm delete',
    ...
    editPlan: 'Edit Plan',
    guestModeBanner: 'You are in guest mode. Data is stored on this device only. Register to sync across devices.',
    ...
    viewAnalytics: 'Learning Analytics',
    startVocab: 'Start',
    startGrammar: 'Start',
  ...
  setup: {
    ...
    hint: 'You can always update this later from the dashboard',
    daysLabel: 'Days until exam',
    daysUnit: 'days',
    levelLabel: 'Current level',
    durationLabel: 'Daily study time',
  ...
  analytics: {
    ...
    back: '← Back',
    loginRequired: 'Please sign in to view learning analytics.',
    title: 'Learning Analytics',
    subtitle: 'Computed from your review records with the FSRS algorithm',
    stateTitle: 'Memory State Distribution',
    forecastTitle: 'Next 7 Days Review Forecast',
    byTopicTitle: 'Topic Mastery',
    byTopicEmpty: 'Review more words to unlock topic mastery insights.',
    topicOther: 'Other',
    byTopicRow: '{mature}/{total} words stable · avg {days} days',
    cardReviewed: 'Reviewed Words',
    cardReviewedSub: '{n} words total',
    cardDueToday: 'Due Today',
    cardDueTodaySub: 'Need to finish today',
    cardMature: 'Mature Words',
    cardMatureSub: 'Long-term memory count',
    cardStability: 'Avg Stability',
    cardStabilityValue: '{n} days',
    cardStabilitySub: 'Half-life on forgetting curve',
