    ...
    <div className="min-h-dvh bg-[#FAFAFA] px-6 py-10 text-slate-900">
      <div className="mx-auto w-full max-w-md">
        ...
        <header className="mb-6 rounded-2xl border border-slate-200 bg-slate-50/90 px-5 py-5">
          <span className="inline-flex rounded-full bg-[#ede9fe] px-3 py-1 text-xs font-semibold text-[#6C5CE7] ring-1 ring-[#ddd6fe]">
            {TOPIC_TYPE}
          </span>
        ...
        <section className="mb-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <span className="text-2xl font-bold tabular-nums text-[#6C5CE7]">
        ...
        <section className="rounded-2xl border border-slate-200 bg-slate-50/80 p-5 text-center">
          <button
            ...
            className={`mx-auto flex h-28 w-28 items-center justify-center rounded-full text-5xl shadow-sm transition disabled:cursor-not-allowed disabled:bg-slate-200 ${
              isRecording
                ? 'recording-pulse bg-rose-500 text-white hover:bg-rose-600'
                : 'bg-[#FDCB6E] text-black hover:brightness-105'
            }`}
        ...
        <button
          ...
          className="mt-6 w-full rounded-xl bg-gradient-to-r from-[#6C5CE7] to-[#8B5CF6] py-3.5 text-base font-semibold text-white shadow-sm transition hover:brightness-105 disabled:cursor-not-allowed disabled:bg-slate-300 disabled:text-slate-500"
        >
            ...
            {cards.map(([key, label, item]) => (
              <div key={key} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <div className="flex items-center justify-between gap-3">
                  <h2 className="border-l-4 border-[#6C5CE7] pl-2 font-semibold text-slate-900">{label}</h2>
                  <span className="rounded-full bg-[#ede9fe] px-3 py-1 text-sm font-bold text-[#6C5CE7]">
                    {item.score}/5
                  </span>
                </div>
